            ...
            <div class="container mx-auto px-6 py-1 pb-16">
              <div class="bg-white shadow-md rounded my-6 p-5">
                <form method="POST" action="{{ route('admin.users.store')}}">
                  ...
                  <div class="flex flex-col space-y-2">
                    <label for="name" class="text-gray-700 select-none font-medium">Pseudonym</label>
                    <input id="name" type="text" name="pseudonym" value="{{ old('name') }}"
                      placeholder="Enter Pseudonym" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200"
                    />
                  </div>

                  <div class="flex flex-col space-y-2">
                    <label for="name" class="text-gray-700 select-none font-medium">Designation</label>
                    <input id="name" type="text" name="designation" value="{{ old('name') }}"
                  ...
                  <div class="flex flex-col space-y-2">
                      ...
                      <input id="email" type="text" name="phone" value="{{ old('email') }}"
