                ...
                <table class="text-left w-full border-collapse">
                  <thead>
                    <tr>
                      ...
                      <th class="py-4 px-6 bg-grey-lightest font-bold text-sm text-grey-dark border-b border-grey-light">Pseudonym</th>
                      <th class="py-4 px-6 bg-grey-lightest font-bold text-sm text-grey-dark border-b border-grey-light">Designation</th>
                  ...
                  <tbody>
                    ...
                    @can('User access')
                      ...
                      <tr class="hover:bg-grey-lighter">
                        ...
                        <td class="py-4 px-6 border-b border-grey-light">{{ $user->pseudonym }}</td>
                        <td class="py-4 px-6 border-b border-grey-light">{{ $user->designation }}</td>
